            ...
            <View style={[styles.mainContainer, ThemeStyle.iosClass]}>
                <View style={styles.mainWrapper}>
                    ...
                    <View style={styles.nameWrapper}>
                        <Text style={[styles.nameText]}>Sign Up</Text>
                    </View>
                </View>
                ...
                <View style={styles.subWrapper}>
                    ...
                    <Button
                        ...
                        btnTextColor={activeBTN ? COLORS.ShadowDarkest : COLORS.SecondaryDarkestWithOpacityforBTN}
                        btnwidth="100%"
                        onPress={() => {
...
const styles = StyleSheet.create({
    ...
    subWrapper: { paddingHorizontal: width * 0.06, marginBottom: 80 },
    ...
    line: { flex: 1, height: 0, borderTopWidth: 1, borderTopColor: '#D1CDD8' },
    text: {
